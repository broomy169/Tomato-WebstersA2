...
if ($_REQUEST['submit'] == "X")
{
    ...
    if ($dbh->exec($sql))
        header("Location: manageBandIndex.php");
}
?>
...
<body>
<h3><a href="manageBandIndex.php">Return to Manage band database</a></h3>
<h1>Results</h1>
...
band_id = '$_REQUEST[band_id]'";
    ...
    if ($dbh->exec($sql))
        echo "<div id='update'><h2>Updated record: $_REQUEST[band_name] (ID: $_REQUEST[band_id])</h2></div>";
    else
...
$dbh = null;
?>
<h3><a href="manageBandIndex.php">Return to Manage band database</a></h3></body>
</html>