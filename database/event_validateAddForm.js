function eveValidateAddForm() {
    ...
    var venueName = document.forms["addEvent"]["event_venueName"].value;
    var venueLocation = document.forms["addEvent"]["event_venueLocation"].value;
