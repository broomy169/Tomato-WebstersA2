...
if ($_REQUEST['submit'] == "Add Entry")
{
    ...
    if ($dbh->exec($sql)) {
        $_SESSION['genreEdit'] = "Genre category " . $_REQUEST[genre_name] . " successfully added";
    } else {
        $_SESSION['genreEdit'] = "Genre category " . $_REQUEST[genre_name] . " not added. Please contact system/server admin";
    }
}
...
else if ($_REQUEST['submit'] == "Update Information")
{
    ...
    if ($dbh->exec($sql)) {
        $_SESSION['genreEdit'] = "Genre category " . $_REQUEST[genre_name] . " successfully updated";
    } else {
        $_SESSION['genreEdit'] = "Genre category " . $_REQUEST[genre_name] . " not updated. Please contact system/server admin";
    }
}
...
else if ($_REQUEST['submit'] == "Delete Entry")
{
    ...
    //echo "<p>Query: " . $sql . "</p>\n<p><strong>";
    if ($dbh->exec($sql)) {
        $_SESSION['genreEdit'] = "Genre category " . $_REQUEST[genre_name] . " successfully deleted";
    } else {
        $_SESSION['genreEdit'] = "Genre category " . $_REQUEST[genre_name] . " not Deleted. Please contact system/server admin";
    }
}
